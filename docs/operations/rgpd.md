...
| Cloudflare | DNS, TLS, Worker, Static Assets, futur Tunnel et futur R2 | IP, requêtes et en-têtes au bord ; objets média seulement après activation de R2 | Apex et `www` actifs pour l'Onboarding ; Workers Logs et Traces désactivés tant que des capacités restent dans les URL ; aucun Tunnel ni R2 ; preuve du DPA, localisation et rétention à joindre au registre avant tout trafic testeur ou nouvelle Route |
