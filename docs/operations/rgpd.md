...
| OVHcloud, hébergeur d'Atlas | Hébergement futur du Backend et de PostgreSQL Surplasse | L'ensemble des données en base après activation | Hébergeur retenu ; Surplasse reste désactivé et la localisation contractuelle exacte doit être jointe au registre avant le pilote |
