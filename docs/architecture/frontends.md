...
Le choix de trois applications React distinctes plutôt qu'une application unique ou qu'un framework SSR est motivé dans [l'ADR 0004](../decisions/adr-0004-trois-frontends-react.md). L'[ADR-0044](../decisions/adr-0044-frontends-canoniques-uniques.md) en fait les seules implémentations maintenues.
...
| Temps réel | Oui : flux SSE de suivi de la commande ([ADR-0006](../decisions/adr-0006-sse.md)) ; polling en repli si le flux ne s'établit pas | Oui : flux SSE des commandes de l'établissement et resynchronisation REST | Non |
