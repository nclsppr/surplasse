...
| **Stripe Connect** | Technique | Offre de Stripe conçue pour les plateformes : chaque établissement dispose d'un compte connecté qui reçoit les fonds de ses commandes, Surplasse orchestrant le paiement. Le type de comptes (Express) est acté dans l'[ADR-0007](decisions/adr-0007-stripe.md) ; le montant de la commission reste à trancher. | [Intégrations](architecture/integrations.md) |
