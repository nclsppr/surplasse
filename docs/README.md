...
| Existant dans le dépôt | Applications locales, topologie HTTPS `surplasse.test`, commandes npm et Compose directes, documentation, marque et préfiguration statique de l'Onboarding |
...
| Développement | Tout ce qu'il faut pour contribuer au code : environnement `mise`, domaines, commandes locales, conventions, tests et mises à jour Renovate | [Setup](developpement/index.md), [Domaines locaux](developpement/domaines-locaux.md), [Conventions React](developpement/conventions-react.md), [Conventions Quarkus](developpement/conventions-quarkus.md), [Conventions API](developpement/conventions-api.md), [Git](developpement/workflow-git.md), [Tests](developpement/tests.md), [CI/CD](developpement/ci-cd.md) |
| Opérations | L'exploitation du système en production | [Environnements](operations/environnements.md), [Déploiement Atlas](operations/deploiement-compose.md), [Observabilité](operations/observabilite.md), [Pilote de phase 2](operations/pilote.md), [RGPD](operations/rgpd.md) |
...
Le fichier `docs/AGENTS.md` et le répertoire `docs/agents/` sont exclus du site publié. Ils fixent les conventions documentaires et la configuration des skills d'ingénierie. Toute contribution respecte `docs/AGENTS.md` ; en cas de contradiction entre une page et lui, c'est la page qui est corrigée.
