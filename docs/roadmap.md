...
Le Dashboard minimal de cette phase est livré localement, y compris l'indicateur permanent de connexion temps réel. Le remboursement reste volontairement hors de la route de statut : il doit passer par le domaine paiement et déclencher une vraie opération Stripe. Viennent ensuite les deux durcissements navigateur obligatoires, le passage Stripe en conditions live, le service à blanc, les corrections issues du pilote et enfin le service réel qui constitue le critère de sortie de la phase.
