...
public class DashboardOrder   {
  ...
  public enum StatusEnum {
    ...
    PAID(String.valueOf("paid")), ACCEPTED(String.valueOf("accepted")), PREPARING(String.valueOf("preparing")), READY(String.valueOf("ready"));
   ...
   **/
  public DashboardOrder id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   **/
  public DashboardOrder displayNumber(String displayNumber) {
    this.displayNumber = displayNumber;
    return this;
  }
   ...
   **/
  public DashboardOrder status(StatusEnum status) {
    this.status = status;
    return this;
  }
   ...
   * Type of the order.
   **/
  public DashboardOrder type(TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   **/
  public DashboardOrder tableLabel(String tableLabel) {
   ...
   **/
  public DashboardOrder lines(List<@Valid OrderLine> lines) {
    this.lines = lines;
    return this;
  }
  ...
  public DashboardOrder addLinesItem(OrderLine linesItem) {
    if (this.lines == null) {
  ...
  public DashboardOrder removeLinesItem(OrderLine linesItem) {
   ...
   * minimum: 0
   **/
  public DashboardOrder totalCents(Integer totalCents) {
    this.totalCents = totalCents;
    return this;
  }
   ...
   **/
  public DashboardOrder currency(String currency) {
    this.currency = currency;
    return this;
  }
   ...
   **/
  public DashboardOrder createdAt(OffsetDateTime createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DashboardOrder dashboardOrder = (DashboardOrder) o;
    return Objects.equals(this.id, dashboardOrder.id) &&
        Objects.equals(this.displayNumber, dashboardOrder.displayNumber) &&
        Objects.equals(this.status, dashboardOrder.status) &&
        Objects.equals(this.type, dashboardOrder.type) &&
        Objects.equals(this.tableLabel, dashboardOrder.tableLabel) &&
        Objects.equals(this.lines, dashboardOrder.lines) &&
        Objects.equals(this.totalCents, dashboardOrder.totalCents) &&
        Objects.equals(this.currency, dashboardOrder.currency) &&
        Objects.equals(this.createdAt, dashboardOrder.createdAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, displayNumber, status, type, tableLabel, lines, totalCents, currency, createdAt);
  }
