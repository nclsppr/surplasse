export const fr = {
  ...
  auth: {
    experiment: "Interface 2",
    visualCaption: "Le service, sans détour.",
    ...
    pagesDemoBadge: "Démonstration statique",
    pagesDemoDescription:
      "Ce build GitHub Pages ne transmet aucune adresse email. La connexion réelle se vérifie avec le Backend du profil development.",
