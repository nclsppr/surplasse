...
export const fr = {
  ...
  menu: {
    ...
    pagesDemoBadge: "Données de démonstration",
    pagesDemoDescription:
      "Cette carte est synthétique et réservée à la revue visuelle sur GitHub Pages. Aucune commande ni aucun paiement n'est transmis.",
  },
  product: {
